...
//#endregion
//#region node_modules/country-codes-list/dist/utils/supplant.js
var require_supplant = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	/**
	...
	*/
	function supplant(template, data) {
		return template.replace(/{([^{}]*)}/g, (match, key) => {
			...
			return typeof value === "string" || typeof value === "number" ? value.toString() : match;
		});
	}
	exports.default = supplant;
}));
//#endregion
//#region node_modules/country-codes-list/dist/countriesData.js
var require_countriesData = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = [
		{
...
//#endregion
//#region node_modules/country-codes-list/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var supplant_1 = __importDefault(require_supplant());
	var countriesData_1 = __importDefault(require_countriesData());
	exports.utils = { groupBy: groupBy_1.default };
	function all() {
	...
	function customArray(fields = {
		...
		if (typeof filterFunc === "function") data = data.filter(filterFunc);
		if (sortDataBy) {
		...
		data.forEach((countryData) => {
			...
			for (const field in fields) collectionObject[field] = (0, supplant_1.default)(fields[field], countryData);
...
//# sourceMappingURL=country-codes-list.js.map