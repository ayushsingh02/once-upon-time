...
const data = {
  ...
  nav: [
    {
      head: "Service",
      links: ["Therapy", "Training", "Workshops", "Talks"],
    },
    {
      head: "About",
      links: ["Stories", "Referrals"],
    },
    {
      head: "Terms and Conditions",
      links: ["Privacy Policy", "Refunds & Cancellations"],
    },
  ],
  socials: [
            ...
            <div className="footer-in">
              ...
              <div className="footer-copyright">
                  ...
                  <p>
                    <span>
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6.875 13.25C10.3958 13.25 13.25 10.3958 13.25 6.875C13.25 3.35418 10.3958 0.5 6.875 0.5C3.35418 0.5 3.35418 13.25 6.875 13.25Z" stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className="design-by">
                  <p>
                    Designed by <a href={data.designedBy.link}>{data.designedBy.label}</a>
                  </p>
                </div>
              </div>
